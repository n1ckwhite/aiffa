      ...
      <VStack align="stretch" spacing={4}>
        <VStack align="center" spacing={3} textAlign="center">
          ...
          <Text fontSize="sm" color={subtitleColor} maxW={{ base: "full", md: "640px" }}>
            Здесь отмечаем авторов материалов AIFFA: важен не объём публикаций, а их качество и то, сколько звёзд и
            благодарностей ставит комьюнити за пользу. Показываем топ‑3 за месяц.
          </Text>
