      ...
      >
        ...
        >
          ...
          >
            ...
            >
              AIFFA — это экосистема, которую создают авторы материалов и задач недели, мейнтейнеры проектов, авторы
              статей, участники хакатонов и те, кто поддерживает идею. Здесь можно найти людей, с которыми вы будете
              расти, запускать проекты и усиливать комьюнити.
            </Text>
            <Stack
              as="ul"
            ...
            >
              ...
              >
                ...
                <Text fontSize={{ base: "xs", md: "sm" }} color={secondaryTextColor}>
                  Помогают улучшать материалы и задачи, чтобы обучение оставалось актуальным.
                </Text>
              </HStack>
              <HStack
                as="li"
