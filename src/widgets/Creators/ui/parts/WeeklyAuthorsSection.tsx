      ...
      <VStack align="stretch" spacing={4}>
        <VStack align="center" spacing={3} textAlign="center">
          ...
          <Text fontSize="sm" color={subtitleColor} maxW={{ base: "full", md: "640px" }}>
            Здесь мы отмечаем авторов задач недели: ценим не количество, а практичность задач и отклик — сколько звёзд и
            благодарностей даёт комьюнити за то, что weekly помогают не выпадать из практики. Это топ‑3 за текущую неделю.
          </Text>
