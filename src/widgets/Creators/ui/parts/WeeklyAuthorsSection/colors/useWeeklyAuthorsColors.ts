...
export const useWeeklyAuthorsColors = () => {
  ...
  const weekMetaColor = useColorModeValue("gray.800", "gray.200");
  const weekCalendarIconColor = useColorModeValue("cyan.700", "cyan.300");
  const weekClockIconColor = useColorModeValue("blue.700", "blue.300");
  ...
  const weekLabelColor = useColorModeValue("cyan.800", "cyan.200");
  const weekTimeHighlight = useColorModeValue("blue.700", "blue.200");
