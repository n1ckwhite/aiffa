        ...
        <VStack spacing={12} align="center">
          <VStack spacing={6} textAlign="center" maxW="full">
            ...
            <Text
              ...
              maxW="full"
            >
              Universe — это не курсы. Это среда роста разработчиков.
...
Всё открыто и бесплатно. Чем больше твой вклад, тем выше уровень, шире сеть контактов и сильнее становится Universe. 
            </Text>
          </VStack>
          <SimpleGrid 
