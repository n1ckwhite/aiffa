...
export const ModuleLessonsView: React.FC<ModuleLessonsViewProps> = ({ mod, profileSolvedTaskIds }) => {
    ...
    <Box pb="32px" px={{ base: 4, md: 6 }} py={{ base: 8, md: 10 }}>
      <Box px={0}>
        <VStack align="stretch" gap={7} maxW={{ base: '100%', md: '900px' }} mx="auto">
          ...
          <LessonsGrid mod={mod} colors={colors} solvedMap={profileSolvedTaskIds || {}} />
