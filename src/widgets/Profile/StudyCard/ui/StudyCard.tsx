...
const StudyCard: React.FC<StudyCardProps> = ({ isManifestLoaded, studyProgressPct, ringTrack, ringColor, skeletonBg, skeletonRingBorder, skeletonRingTop, dividerColor, hintColor, onOpenMaterials }) => {
  return (
    <Box bg="transparent" borderRadius="2xl" p={{ base: 3, md: 4 }} h="100%" display="flex" flexDirection="column">
      <VStack spacing={4} align="stretch">
        ...
        <FooterCTA dividerColor={dividerColor} hintColor={hintColor} onOpenMaterials={onOpenMaterials} />
      </VStack>
    </Box>
  );
};
